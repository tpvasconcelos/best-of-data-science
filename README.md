...
- [GitHub](https://github.com/pallets/click) (👨‍💻 310 · 🔀 1.2K · 📦 660K · 📋 1.3K - 4% open · ⏱️ 11.11.2021):
...
<details><summary><b><a href="https://github.com/pygments/pygments">pygments</a></b> (🥈36 ·  ⭐ 780) - Pygments is a generic syntax highlighter written in Python. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pygments/pygments) (👨‍💻 670 · 🔀 330 · 📦 270K · 📋 1.5K - 20% open · ⏱️ 24.11.2021):

	```
	git clone https://github.com/pygments/pygments
	```
- [PyPi](https://pypi.org/project/Pygments) (📥 30M / month):
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.2K · 📦 9.8K · 📋 240 - 40% open · ⏱️ 17.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/fire) (📥 1.7M / month):
	```
	pip install fire
	```
</details>
<details><summary><b><a href="https://github.com/prompt-toolkit/python-prompt-toolkit">python-prompt-toolkit</a></b> (🥉25 ·  ⭐ 7.4K · 📉) - Library for building powerful interactive command.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 200 · 🔀 570 · 📋 920 - 45% open · ⏱️ 22.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/prompt-toolkit) (📥 21M / month):
	```
...
- [GitHub](https://github.com/tiangolo/typer) (👨‍💻 9 · 🔀 240 · 📋 210 - 54% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/typer) (📥 3.8M / month):
	```
	pip install typer
	```
</details>
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 46 · 🔀 160 · 📦 18K · 📋 69 - 33% open · ⏱️ 27.07.2021):

	```
	git clone https://github.com/madzak/python-json-logger
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 4.4M / month):
	```
...
- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 22 · 🔀 45 · 📦 220 · 📋 57 - 10% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/bobbui/json-logging-python
	```
- [PyPi](https://pypi.org/project/json-logging) (📥 660K / month):
	```
...
- [GitHub](https://github.com/Qix-/better-exceptions) (👨‍💻 15 · 🔀 190 · 📋 65 - 36% open · ⏱️ 19.10.2021):

	```
	git clone https://github.com/Qix-/better-exceptions
	```
- [PyPi](https://pypi.org/project/better-exceptions) (📥 26K / month):
	```
	pip install better-exceptions
	```
</details>
<details><summary><b><a href="https://github.com/hynek/structlog">structlog</a></b> (🥉20 ·  ⭐ 1.8K · 📉) - Structured Logging for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/hynek/structlog) (👨‍💻 81 · 🔀 150 · 📋 200 - 12% open · ⏱️ 25.11.2021):
...
<details><summary><b><a href="https://boltons.readthedocs.io/en/latest/cacheutils.html">boltons.cacheutils</a></b> (🥈28 ·  ⭐ 5.7K · 📉) - `boltons.cacheutils` contains consistent.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 510 · 📋 94 - 48% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/uqfoundation/klepto
	```
- [PyPi](https://pypi.org/project/klepto) (📥 19K / month):
	```
	pip install klepto
	```
</details>
...
<details><summary><b><a href="https://github.com/theskumar/python-dotenv">python-dotenv</a></b> (🥇32 ·  ⭐ 4.5K · 📉) - Get and set values in your .env file in local and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/theskumar/python-dotenv) (👨‍💻 71 · 🔀 280 · 📦 170K · 📋 190 - 8% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/theskumar/python-dotenv
	```
- [PyPi](https://pypi.org/project/python-dotenv) (📥 12M / month):
	```
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 75 · 🔀 190 · 📦 1.9K · 📋 320 - 26% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/rochacbruno/dynaconf
	```
- [PyPi](https://pypi.org/project/dynaconf) (📥 540K / month):
	```
	pip install dynaconf
	```
</details>
<details><summary><b><a href="https://github.com/henriquebastos/python-decouple">python-decouple</a></b> (🥈30 ·  ⭐ 2K · 📈) - Strict separation of config from code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/sloria/environs">environs</a></b> (🥉26 ·  ⭐ 770 · 📉) - simplified environment variable parsing. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sloria/environs) (👨‍💻 23 · 🔀 50 · 📦 6.4K · 📋 68 - 5% open · ⏱️ 15.11.2021):
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 82 · 🔀 370 · 📦 3 · 📋 930 - 10% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/hydra) (📥 6.9K / month):
	```
	pip install hydra
	```
</details>
...
<details><summary><b><a href="https://github.com/arrow-py/arrow">arrow</a></b> (🥇35 ·  ⭐ 7.7K) - Better dates & times for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 250 · 🔀 600 · 📦 23K · 📋 440 - 14% open · ⏱️ 23.11.2021):
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 380 · 📥 35K · 📦 600K · 📋 590 - 37% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-dateutil) (📥 170M / month):
	```
	pip install python-dateutil
	```
</details>
<details><summary><b><a href="https://github.com/stub42/pytz">pytz</a></b> (🥉30 ·  ⭐ 190 · 📉) - pytz Python historical timezone library and database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/stub42/pytz) (👨‍💻 16 · 🔀 57 · 📦 920K · 📋 39 - 38% open · ⏱️ 11.10.2021):

	```
	git clone https://github.com/stub42/pytz
	```
- [PyPi](https://pypi.org/project/pytz) (📥 73M / month):
	```
	pip install pytz
	```
</details>
...
<details><summary><b><a href="https://github.com/seperman/deepdiff">deepdiff</a></b> (🥇29 ·  ⭐ 1.2K) - Deep Difference and search of any Python object/data. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/seperman/deepdiff) (👨‍💻 57 · 🔀 150 · 📦 2.6K · 📋 170 - 18% open · ⏱️ 13.10.2021):

	```
	git clone https://github.com/seperman/deepdiff
	```
- [PyPi](https://pypi.org/project/deepdiff) (📥 3.4M / month):
	```
	pip install deepdiff
	```
</details>
<details><summary><b><a href="https://github.com/cloudpipe/cloudpickle">cloudpickle</a></b> (🥇29 ·  ⭐ 1.1K) - Extended pickling support for Python objects. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/cloudpipe/cloudpickle) (👨‍💻 48 · 🔀 120 · 📥 19 · 📦 44K · 📋 200 - 30% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/cloudpickle) (📥 22M / month):
	```
	pip install cloudpickle
	```
</details>
<details><summary><b><a href="https://github.com/mahmoud/boltons">boltons</a></b> (🥈28 ·  ⭐ 5.7K · 📉) - Like builtins, but boltons. 250+ constructs, recipes, and.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/r1chardj0n3s/parse) (👨‍💻 30 · 🔀 83 · 📦 9.7K · 📋 82 - 21% open · ⏱️ 04.06.2021):
...
- [GitHub](https://github.com/GrahamDumpleton/wrapt) (👨‍💻 21 · 🔀 200 · 📋 140 - 20% open · ⏱️ 29.10.2021):

	```
	git clone https://github.com/GrahamDumpleton/wrapt
	```
- [PyPi](https://pypi.org/project/wrapt) (📥 40M / month):
	```
	pip install wrapt
	```
</details>
