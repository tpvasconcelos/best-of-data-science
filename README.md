...
- [GitHub](https://github.com/pallets/click) (👨‍💻 310 · 🔀 1.1K · 📦 580K · 📋 1.2K - 5% open · ⏱️ 05.08.2021):
...
- [GitHub](https://github.com/pygments/pygments) (👨‍💻 640 · 🔀 720 · 📦 240K · 📋 1.5K - 22% open · ⏱️ 31.07.2021):

	```
	git clone https://github.com/pygments/pygments
	```
- [PyPi](https://pypi.org/project/Pygments) (📥 27M / month · 📦 68K · ⏱️ 03.05.2021):
	```
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 100 · 🔀 850 · 📦 5.8K · 📋 490 - 1% open · ⏱️ 05.08.2021):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 1.9M / month · ⏱️ 05.08.2021):
	```
	pip install rich
	```
</details>
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.2K · 📦 8.5K · 📋 250 - 42% open · ⏱️ 17.06.2021):

	```
	git clone https://github.com/google/python-fire
	```
- [PyPi](https://pypi.org/project/fire) (📥 1.3M / month · 📦 1.2K · ⏱️ 22.01.2021):
	```
	pip install fire
	```
</details>
<details><summary><b><a href="https://github.com/prompt-toolkit/python-prompt-toolkit">python-prompt-toolkit</a></b> (🥉32 ·  ⭐ 7.2K · 📈) - Library for building powerful interactive command line applications in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 190 · 🔀 560 · 📋 920 - 46% open · ⏱️ 05.08.2021):

	```
	git clone https://github.com/prompt-toolkit/python-prompt-toolkit
	```
- [PyPi](https://pypi.org/project/prompt-toolkit) (📥 18M / month · 📦 530 · ⏱️ 17.06.2021):
	```
...
- [GitHub](https://github.com/tiangolo/typer) (👨‍💻 8 · 🔀 220 · 📋 210 - 58% open · ⏱️ 16.08.2020):
...
<details><summary><b><a href="https://github.com/willmcgugan/rich">rich.logging</a></b> (🥇33 ·  ⭐ 28K) - Rich is a Python library for rich text and beautiful formatting in the terminal. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 100 · 🔀 220 · 📥 4.5K · 📦 13K · 📋 550 - 30% open · ⏱️ 27.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 9.2M / month · 📦 990 · ⏱️ 27.07.2021):
	```
	pip install sentry-sdk
	```
</details>
<details><summary><b><a href="https://github.com/madzak/python-json-logger">python-json-logger</a></b> (🥈32 ·  ⭐ 1K · 📈) - Json Formatter for the standard python logger. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 46 · 🔀 150 · 📦 16K · 📋 65 - 30% open · ⏱️ 27.07.2021):

	```
	git clone https://github.com/madzak/python-json-logger
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 3.5M / month · 📦 920 · ⏱️ 27.07.2021):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 29 · 🔀 420 · 📦 9K · 📋 430 - 11% open · ⏱️ 17.07.2021):
...
<details><summary><b><a href="https://github.com/hynek/structlog">structlog</a></b> (🥉27 ·  ⭐ 1.6K · 📈) - Structured Logging for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hynek/structlog) (👨‍💻 73 · 🔀 140 · 📦 3.5K · 📋 190 - 17% open · ⏱️ 02.08.2021):

	```
	git clone https://github.com/hynek/structlog
	```
- [PyPi](https://pypi.org/project/structlog) (📥 2.2M / month · 📦 1.2K · ⏱️ 18.02.2021):
	```
	pip install structlog
	```
</details>
<details><summary><b><a href="https://github.com/bobbui/json-logging-python">json-logging-python</a></b> (🥉25 ·  ⭐ 180) - Cloud-native distributed Python logging library to emit JSON log that can be easily indexed by logging infrastructure. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 21 · 🔀 43 · 📦 180 · 📋 53 - 9% open · ⏱️ 24.07.2021):

	```
	git clone https://github.com/bobbui/json-logging-python
	```
- [PyPi](https://pypi.org/project/json-logging) (📥 930K / month · 📦 8 · ⏱️ 09.07.2021):
	```
...
<details><summary><b><a href="https://joblib.readthedocs.io/en/latest/generated/joblib.Memory.html">joblib.Memory</a></b> (🥇35 ·  ⭐ 2.5K · 📈) - `joblib.Memory` defines a context object for caching a functions return value each time it is called with the same.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/joblib/joblib) (👨‍💻 100 · 🔀 290 · 📦 120K · 📋 660 - 44% open · ⏱️ 11.06.2021):
...
<details><summary><b><a href="https://boltons.readthedocs.io/en/latest/cacheutils.html">boltons.cacheutils</a></b> (🥈30 ·  ⭐ 5.5K · 📈) - `boltons.cacheutils` contains consistent implementations of fundamental cache types. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 72 · 🔀 300 · 📥 21 · 📦 1.6K · 📋 130 - 31% open · ⏱️ 19.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/boltons) (📥 1M / month · 📦 490 · ⏱️ 17.05.2021):
	```
	pip install boltons
	```
</details>
...
- [GitHub](https://github.com/tkem/cachetools) (👨‍💻 5 · 🔀 110 · 📋 180 - 5% open · ⏱️ 27.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/cachetools) (📥 42M / month · 📦 4.4K · ⏱️ 27.04.2021):
	```
...
- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 400 · 📋 91 - 52% open · ⏱️ 17.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/klepto) (📥 74K / month · 📦 12 · ⏱️ 13.06.2021):
	```
	pip install klepto
	```
</details>
...
<details><summary><b><a href="https://github.com/theskumar/python-dotenv">python-dotenv</a></b> (🥇34 ·  ⭐ 4.1K · 📈) - Get and set values in your .env file in local and production servers. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/theskumar/python-dotenv) (👨‍💻 71 · 🔀 260 · 📦 130K · 📋 180 - 7% open · ⏱️ 25.07.2021):
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 69 · 🔀 180 · 📦 1.4K · 📋 300 - 27% open · ⏱️ 04.08.2021):

	```
	git clone https://github.com/rochacbruno/dynaconf
	```
- [PyPi](https://pypi.org/project/dynaconf) (📥 380K / month · 📦 92 · ⏱️ 08.03.2021):
	```
...
- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 24 · 🔀 140 · 📦 43K · 📋 72 - 22% open · ⏱️ 05.06.2021):
...
<details><summary><b><a href="https://github.com/sloria/environs">environs</a></b> (🥉27 ·  ⭐ 710 · 📈) - simplified environment variable parsing. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sloria/environs) (👨‍💻 21 · 🔀 45 · 📦 4.8K · 📋 66 - 9% open · ⏱️ 12.05.2021):

	```
	git clone https://github.com/sloria/environs
	```
- [PyPi](https://pypi.org/project/environs) (📥 430K / month · 📦 180 · ⏱️ 07.02.2021):
	```
	pip install environs
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉24 ·  ⭐ 4.6K · 📈) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 76 · 🔀 370 · 📦 2 · 📋 830 - 7% open · ⏱️ 06.08.2021):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 5.8K / month · 📦 6 · ⏱️ 03.08.2016):
	```
	pip install hydra
	```
</details>
...
- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 240 · 🔀 580 · 📦 21K · 📋 430 - 13% open · ⏱️ 02.08.2021):
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 66 · 🔀 250 · 📋 420 - 46% open · ⏱️ 11.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 5.4M / month · 📦 1.1K · ⏱️ 24.07.2020):
	```
...
<details><summary><b><a href="https://github.com/GrahamDumpleton/wrapt">wrapt</a></b> (🥇33 ·  ⭐ 1.5K · 📈) - A Python module for decorators, wrappers and monkey patching. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/GrahamDumpleton/wrapt) (👨‍💻 21 · 🔀 190 · 📋 150 - 30% open · ⏱️ 07.08.2021):

	```
	git clone https://github.com/GrahamDumpleton/wrapt
	```
- [PyPi](https://pypi.org/project/wrapt) (📥 33M / month · 📦 21K · ⏱️ 06.08.2021):
	```
	pip install wrapt
	```
</details>
<details><summary><b><a href="https://github.com/mahmoud/boltons">boltons</a></b> (🥈30 ·  ⭐ 5.5K · 📈) - Like builtins, but boltons. 250+ constructs, recipes, and snippets which extend (and rely on nothing but) the Python.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/uqfoundation/dill">dill</a></b> (🥈30 ·  ⭐ 1.5K · 📈) - serialize all of python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/uqfoundation/dill) (👨‍💻 30 · 🔀 120 · 📥 240K · 📋 350 - 39% open · ⏱️ 13.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/dill) (📥 8.6M / month · 📦 5K · ⏱️ 13.06.2021):
	```
	pip install dill
	```
</details>
