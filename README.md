...
- [GitHub](https://github.com/pallets/click) (👨‍💻 310 · 🔀 1.2K · 📦 640K · 📋 1.3K - 4% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/pallets/click
	```
- [PyPi](https://pypi.org/project/click) (📥 110M / month):
	```
	pip install click
	```
</details>
...
- [GitHub](https://github.com/pygments/pygments) (👨‍💻 660 · 🔀 320 · 📦 260K · 📋 1.5K - 20% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 130 · 🔀 960 · 📦 8.1K · 📋 560 - 4% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/rich) (📥 2.5M / month):
	```
	pip install rich
	```
</details>
...
- [GitHub](https://github.com/tiangolo/typer) (👨‍💻 9 · 🔀 240 · 📋 210 - 54% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/typer) (📥 4.3M / month):
	```
	pip install typer
	```
</details>
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 78 · 🔀 140 · 📦 3.8K · 📋 200 - 15% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 21 · 🔀 44 · 📦 210 · 📋 56 - 8% open · ⏱️ 24.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/json-logging) (📥 850K / month):
	```
...
- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 490 · 📋 94 - 48% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/uqfoundation/klepto
	```
- [PyPi](https://pypi.org/project/klepto) (📥 44K / month):
	```
	pip install klepto
	```
</details>
...
- [GitHub](https://github.com/theskumar/python-dotenv) (👨‍💻 71 · 🔀 270 · 📦 160K · 📋 190 - 7% open · ⏱️ 09.10.2021):
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 75 · 🔀 190 · 📦 1.8K · 📋 320 - 25% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 27 · 🔀 140 · 📥 2 · 📦 50K · 📋 70 - 7% open · ⏱️ 30.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 700K / month):
	```
...
- [GitHub](https://github.com/sloria/environs) (👨‍💻 22 · 🔀 49 · 📦 6.1K · 📋 68 - 8% open · ⏱️ 04.10.2021):
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 81 · 🔀 370 · 📦 3 · 📋 910 - 9% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 380 · 📥 35K · 📦 590K · 📋 590 - 37% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-dateutil) (📥 250M / month):
	```
...
- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 250 · 🔀 590 · 📦 23K · 📋 440 - 13% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/stub42/pytz) (👨‍💻 16 · 🔀 55 · 📦 900K · 📋 38 - 39% open · ⏱️ 11.10.2021):

	```
	git clone https://github.com/stub42/pytz
	```
- [PyPi](https://pypi.org/project/pytz) (📥 79M / month):
	```
	pip install pytz
	```
</details>
...
- [GitHub](https://github.com/seperman/deepdiff) (👨‍💻 57 · 🔀 140 · 📦 2.5K · 📋 160 - 17% open · ⏱️ 13.10.2021):
...
<details><summary><b><a href="https://github.com/cloudpipe/cloudpickle">cloudpickle</a></b> (🥉22 ·  ⭐ 1K · 📉) - Extended pickling support for Python objects. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/uqfoundation/dill">dill</a></b> (🥉18 ·  ⭐ 1.5K · 📉) - serialize all of python. <code>❗Unlicensed</code></summary>
