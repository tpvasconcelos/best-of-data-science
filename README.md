...
- [GitHub](https://github.com/pallets/click) (👨‍💻 310 · 🔀 1.1K · 📦 630K · 📋 1.2K - 4% open · ⏱️ 10.10.2021):
...
<details><summary><b><a href="https://github.com/pygments/pygments">pygments</a></b> (🥈36 ·  ⭐ 750) - Pygments is a generic syntax highlighter written in Python. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pygments/pygments) (👨‍💻 650 · 🔀 320 · 📦 260K · 📋 1.5K - 20% open · ⏱️ 17.10.2021):

	```
	git clone https://github.com/pygments/pygments
	```
- [PyPi](https://pypi.org/project/Pygments) (📥 35M / month):
	```
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 130 · 🔀 940 · 📦 7.7K · 📋 560 - 4% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/rich) (📥 2.3M / month):
	```
	pip install rich
	```
</details>
...
<details><summary><b><a href="https://github.com/prompt-toolkit/python-prompt-toolkit">python-prompt-toolkit</a></b> (🥉26 ·  ⭐ 7.3K · 📉) - Library for building powerful interactive command.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 190 · 🔀 560 · 📋 910 - 45% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/prompt-toolkit) (📥 26M / month):
	```
	pip install prompt-toolkit
	```
</details>
<details><summary><b><a href="https://github.com/tiangolo/typer">typer</a></b> (🥉25 ·  ⭐ 6.5K · 📈) - Typer, build great CLIs. Easy to code. Based on Python type hints. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/tiangolo/typer) (👨‍💻 9 · 🔀 240 · 📋 210 - 54% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/typer) (📥 3.3M / month):
	```
	pip install typer
	```
</details>
...
- [GitHub](https://github.com/madzak/python-json-logger) (👨‍💻 46 · 🔀 160 · 📦 18K · 📋 66 - 30% open · ⏱️ 27.07.2021):

	```
	git clone https://github.com/madzak/python-json-logger
	```
- [PyPi](https://pypi.org/project/python-json-logger) (📥 4.1M / month):
	```
	pip install python-json-logger
	```
</details>
<details><summary><b><a href="https://github.com/hynek/structlog">structlog</a></b> (🥉25 ·  ⭐ 1.7K · 📉) - Structured Logging for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/hynek/structlog) (👨‍💻 76 · 🔀 140 · 📦 3.7K · 📋 190 - 15% open · ⏱️ 14.10.2021):

	```
	git clone https://github.com/hynek/structlog
	```
- [PyPi](https://pypi.org/project/structlog) (📥 2.4M / month):
	```
...
- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 21 · 🔀 44 · 📦 200 · 📋 55 - 7% open · ⏱️ 24.07.2021):

	```
	git clone https://github.com/bobbui/json-logging-python
	```
- [PyPi](https://pypi.org/project/json-logging) (📥 970K / month):
	```
...
- [GitHub](https://github.com/joblib/joblib) (👨‍💻 110 · 🔀 300 · 📦 140K · 📋 660 - 43% open · ⏱️ 07.10.2021):

	```
	git clone https://github.com/joblib/joblib
	```
- [PyPi](https://pypi.org/project/joblib) (📥 33M / month):
	```
	pip install joblib
	```
</details>
...
- [GitHub](https://github.com/tkem/cachetools) (👨‍💻 7 · 🔀 120 · 📋 200 - 7% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/cachetools) (📥 47M / month):
	```
...
- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 470 · 📋 93 - 49% open · ⏱️ 21.10.2021):

	```
	git clone https://github.com/uqfoundation/klepto
	```
- [PyPi](https://pypi.org/project/klepto) (📥 61K / month):
	```
	pip install klepto
	```
</details>
...
- [GitHub](https://github.com/theskumar/python-dotenv) (👨‍💻 71 · 🔀 280 · 📦 160K · 📋 190 - 8% open · ⏱️ 09.10.2021):
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 74 · 🔀 180 · 📦 1.8K · 📋 320 - 26% open · ⏱️ 18.10.2021):

	```
	git clone https://github.com/rochacbruno/dynaconf
	```
- [PyPi](https://pypi.org/project/dynaconf) (📥 500K / month):
	```
...
- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 27 · 🔀 140 · 📥 2 · 📦 49K · 📋 70 - 7% open · ⏱️ 30.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 660K / month):
	```
	pip install python-decouple
	```
</details>
<details><summary><b><a href="https://github.com/sloria/environs">environs</a></b> (🥉26 ·  ⭐ 750 · 📉) - simplified environment variable parsing. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sloria/environs) (👨‍💻 22 · 🔀 49 · 📦 5.9K · 📋 68 - 8% open · ⏱️ 04.10.2021):

	```
	git clone https://github.com/sloria/environs
	```
- [PyPi](https://pypi.org/project/environs) (📥 490K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 81 · 🔀 360 · 📦 3 · 📋 900 - 9% open · ⏱️ 21.10.2021):
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 380 · 📥 35K · 📦 580K · 📋 590 - 37% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-dateutil) (📥 190M / month):
	```
...
- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 240 · 🔀 590 · 📦 23K · 📋 440 - 13% open · ⏱️ 20.10.2021):

	```
	git clone https://github.com/arrow-py/arrow
	```
- [PyPi](https://pypi.org/project/arrow) (📥 5.2M / month):
	```
	pip install arrow
	```
</details>
...
- [GitHub](https://github.com/stub42/pytz) (👨‍💻 16 · 🔀 55 · 📦 880K · 📋 38 - 39% open · ⏱️ 11.10.2021):

	```
	git clone https://github.com/stub42/pytz
	```
- [PyPi](https://pypi.org/project/pytz) (📥 76M / month):
	```
	pip install pytz
	```
</details>
...
<details><summary><b><a href="https://github.com/cloudpipe/cloudpickle">cloudpickle</a></b> (🥇30 ·  ⭐ 1K · 📈) - Extended pickling support for Python objects. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/cloudpipe/cloudpickle) (👨‍💻 48 · 🔀 110 · 📥 19 · 📦 43K · 📋 200 - 29% open · ⏱️ 11.10.2021):

	```
	git clone https://github.com/cloudpipe/cloudpickle
	```
- [PyPi](https://pypi.org/project/cloudpickle) (📥 29M / month):
	```
...
- [GitHub](https://github.com/r1chardj0n3s/parse) (👨‍💻 30 · 🔀 83 · 📦 9.4K · 📋 81 - 20% open · ⏱️ 04.06.2021):
...
- [GitHub](https://github.com/seperman/deepdiff) (👨‍💻 57 · 🔀 140 · 📦 2.4K · 📋 160 - 16% open · ⏱️ 13.10.2021):

	```
	git clone https://github.com/seperman/deepdiff
	```
- [PyPi](https://pypi.org/project/deepdiff) (📥 3.1M / month):
	```
...
- [GitHub](https://github.com/GrahamDumpleton/wrapt) (👨‍💻 21 · 🔀 200 · 📋 140 - 19% open · ⏱️ 17.10.2021):

	```
	git clone https://github.com/GrahamDumpleton/wrapt
	```
- [PyPi](https://pypi.org/project/wrapt) (📥 36M / month):
	```
	pip install wrapt
	```
</details>
...
- [GitHub](https://github.com/uqfoundation/dill) (👨‍💻 31 · 🔀 130 · 📥 250K · 📋 350 - 38% open · ⏱️ 16.10.2021):

	```
	git clone https://github.com/uqfoundation/dill
	```
- [PyPi](https://pypi.org/project/dill) (📥 11M / month):
	```
	pip install dill
	```
</details>
