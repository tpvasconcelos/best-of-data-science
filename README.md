...
- [GitHub](https://github.com/pallets/click) (👨‍💻 310 · 🔀 1.1K · 📦 600K · 📋 1.2K - 4% open · ⏱️ 16.09.2021):

	```
	git clone https://github.com/pallets/click
	```
- [PyPi](https://pypi.org/project/click) (📥 91M / month):
	```
	pip install click
	```
</details>
<details><summary><b><a href="https://github.com/pygments/pygments">pygments</a></b> (🥈36 ·  ⭐ 720) - Pygments is a generic syntax highlighter written in Python. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pygments/pygments) (👨‍💻 650 · 🔀 310 · 📦 250K · 📋 1.5K - 20% open · ⏱️ 11.09.2021):
...
<details><summary><b><a href="https://github.com/willmcgugan/rich">rich</a></b> (🥈33 ·  ⭐ 29K) - Rich is a Python library for rich text and beautiful formatting in the terminal. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 110 · 🔀 870 · 📦 6.8K · 📋 520 - 2% open · ⏱️ 16.09.2021):
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.2K · 📦 9K · 📋 240 - 39% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 190 · 🔀 560 · 📋 900 - 45% open · ⏱️ 14.09.2021):
...
<details><summary><b><a href="https://github.com/tiangolo/typer">typer</a></b> (🥉24 ·  ⭐ 6.2K · 📈) - Typer, build great CLIs. Easy to code. Based on Python type hints. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/typer) (👨‍💻 9 · 🔀 230 · 📋 200 - 54% open · ⏱️ 30.08.2021):

	```
	git clone https://github.com/tiangolo/typer
	```
- [PyPi](https://pypi.org/project/typer) (📥 2.5M / month):
	```
	pip install typer
	```
</details>
...
<details><summary><b><a href="https://github.com/willmcgugan/rich">rich.logging</a></b> (🥇33 ·  ⭐ 29K) - Rich is a Python library for rich text and beautiful formatting in.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 100 · 🔀 220 · 📥 4.5K · 📦 14K · 📋 540 - 29% open · ⏱️ 16.09.2021):
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥉31 ·  ⭐ 9.8K) - Python logging made (stupidly) simple. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 30 · 🔀 440 · 📦 10K · 📋 450 - 13% open · ⏱️ 09.09.2021):
...
<details><summary><b><a href="https://github.com/bobbui/json-logging-python">json-logging-python</a></b> (🥉25 ·  ⭐ 190 · 📉) - Cloud-native distributed Python logging library to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 21 · 🔀 44 · 📦 190 · 📋 55 - 7% open · ⏱️ 24.07.2021):

	```
	git clone https://github.com/bobbui/json-logging-python
	```
- [PyPi](https://pypi.org/project/json-logging) (📥 920K / month):
	```
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 75 · 🔀 140 · 📦 3.6K · 📋 190 - 14% open · ⏱️ 16.09.2021):
...
- [GitHub](https://github.com/joblib/joblib) (👨‍💻 110 · 🔀 300 · 📦 130K · 📋 650 - 42% open · ⏱️ 13.09.2021):
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 72 · 🔀 300 · 📥 21 · 📦 1.7K · 📋 120 - 27% open · ⏱️ 19.05.2021):
...
- [GitHub](https://github.com/tkem/cachetools) (👨‍💻 5 · 🔀 110 · 📋 190 - 6% open · ⏱️ 09.08.2021):
...
<details><summary><b><a href="https://github.com/uqfoundation/klepto">klepto</a></b> (🥉15 ·  ⭐ 200 · 📉) - persistent caching to memory, disk, or database. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 410 · 📋 91 - 52% open · ⏱️ 17.06.2021):

	```
	git clone https://github.com/uqfoundation/klepto
	```
- [PyPi](https://pypi.org/project/klepto) (📥 59K / month):
	```
	pip install klepto
	```
</details>
...
- [GitHub](https://github.com/theskumar/python-dotenv) (👨‍💻 71 · 🔀 270 · 📦 150K · 📋 180 - 7% open · ⏱️ 25.07.2021):
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 71 · 🔀 180 · 📦 1.6K · 📋 300 - 25% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/rochacbruno/dynaconf
	```
- [PyPi](https://pypi.org/project/dynaconf) (📥 400K / month):
	```
	pip install dynaconf
	```
</details>
<details><summary><b><a href="https://github.com/henriquebastos/python-decouple">python-decouple</a></b> (🥉27 ·  ⭐ 1.9K · 📉) - Strict separation of config from code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 24 · 🔀 140 · 📦 46K · 📋 67 - 13% open · ⏱️ 05.06.2021):

	```
	git clone https://github.com/henriquebastos/python-decouple
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 520K / month):
	```
	pip install python-decouple
	```
</details>
<details><summary><b><a href="https://github.com/sloria/environs">environs</a></b> (🥉26 ·  ⭐ 720 · 📉) - simplified environment variable parsing. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sloria/environs) (👨‍💻 21 · 🔀 47 · 📦 5.3K · 📋 68 - 10% open · ⏱️ 09.08.2021):
...
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉21 ·  ⭐ 4.8K · 📉) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 80 · 🔀 350 · 📦 3 · 📋 880 - 8% open · ⏱️ 16.09.2021):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 7K / month):
	```
	pip install hydra
	```
</details>
...
- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 240 · 🔀 580 · 📦 22K · 📋 440 - 13% open · ⏱️ 12.09.2021):

	```
	git clone https://github.com/arrow-py/arrow
	```
- [PyPi](https://pypi.org/project/arrow) (📥 4.5M / month):
	```
	pip install arrow
	```
</details>
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 120 · 🔀 380 · 📥 35K · 📦 560K · 📋 580 - 37% open · ⏱️ 09.08.2021):
...
- [GitHub](https://github.com/stub42/pytz) (👨‍💻 16 · 🔀 54 · 📦 850K · 📋 38 - 39% open · ⏱️ 22.03.2021):

	```
	git clone https://github.com/stub42/pytz
	```
- [PyPi](https://pypi.org/project/pytz) (📥 68M / month):
	```
	pip install pytz
	```
</details>
...
- [GitHub](https://github.com/cloudpipe/cloudpickle) (👨‍💻 48 · 🔀 110 · 📥 19 · 📦 41K · 📋 200 - 29% open · ⏱️ 16.09.2021):

	```
	git clone https://github.com/cloudpipe/cloudpickle
	```
- [PyPi](https://pypi.org/project/cloudpickle) (📥 21M / month):
	```
...
- [GitHub](https://github.com/r1chardj0n3s/parse) (👨‍💻 30 · 🔀 85 · 📦 9.1K · 📋 81 - 20% open · ⏱️ 04.06.2021):
...
- [GitHub](https://github.com/seperman/deepdiff) (👨‍💻 54 · 🔀 140 · 📦 2.3K · 📋 160 - 18% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/uqfoundation/dill) (👨‍💻 30 · 🔀 120 · 📥 240K · 📋 350 - 38% open · ⏱️ 13.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/dill) (📥 9.7M / month):
	```
	pip install dill
	```
</details>
