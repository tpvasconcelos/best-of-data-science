...
- [GitHub](https://github.com/pallets/click) (👨‍💻 300 · 🔀 1.1K · 📦 570K · 📋 1.2K - 4% open · ⏱️ 06.07.2021):

	```
	git clone https://github.com/pallets/click
	```
- [PyPi](https://pypi.org/project/click) (📥 82M / month):
	```
	pip install click
	```
</details>
<details><summary><b><a href="https://github.com/pygments/pygments">pygments</a></b> (🥈36 ·  ⭐ 670) - Pygments is a generic syntax highlighter written in Python. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/pygments/pygments) (👨‍💻 640 · 🔀 290 · 📦 240K · 📋 1.5K - 20% open · ⏱️ 18.07.2021):

	```
	git clone https://github.com/pygments/pygments
	```
- [PyPi](https://pypi.org/project/Pygments) (📥 26M / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 180 · 🔀 550 · 📦 160K · 📋 880 - 44% open · ⏱️ 13.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/prompt-toolkit) (📥 17M / month):
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.1K · 📦 8.3K · 📋 230 - 38% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/tiangolo/typer) (👨‍💻 8 · 🔀 210 · 📋 190 - 54% open · ⏱️ 16.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/typer) (📥 2.2M / month):
	```
	pip install typer
	```
</details>
...
<details><summary><b><a href="https://github.com/getsentry/sentry-python">sentry</a></b> (🥈32 ·  ⭐ 960) - The new Python SDK for Sentry.io. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 99 · 🔀 210 · 📥 4.5K · 📦 13K · 📋 530 - 28% open · ⏱️ 21.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 9.6M / month):
	```
	pip install sentry-sdk
	```
</details>
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥈31 ·  ⭐ 9.4K · 📈) - Python logging made (stupidly) simple. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/hynek/structlog">structlog</a></b> (🥉25 ·  ⭐ 1.6K · 📉) - Structured Logging for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/hynek/structlog) (👨‍💻 73 · 🔀 140 · 📦 3.4K · 📋 180 - 15% open · ⏱️ 20.07.2021):

	```
	git clone https://github.com/hynek/structlog
	```
- [PyPi](https://pypi.org/project/structlog) (📥 2.1M / month):
	```
...
- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 21 · 🔀 42 · 📦 180 · 📋 51 - 5% open · ⏱️ 09.07.2021):

	```
	git clone https://github.com/bobbui/json-logging-python
	```
- [PyPi](https://pypi.org/project/json-logging) (📥 1.2M / month):
	```
...
- [GitHub](https://github.com/Qix-/better-exceptions) (👨‍💻 14 · 🔀 180 · 📋 63 - 34% open · ⏱️ 29.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/better-exceptions) (📥 29K / month):
	```
...
- [GitHub](https://github.com/tkem/cachetools) (👨‍💻 5 · 🔀 110 · 📋 180 - 6% open · ⏱️ 27.04.2021):

	```
	git clone https://github.com/tkem/cachetools
	```
- [PyPi](https://pypi.org/project/cachetools) (📥 41M / month):
	```
...
- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 400 · 📋 91 - 52% open · ⏱️ 17.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/klepto) (📥 110K / month):
	```
	pip install klepto
	```
</details>
...
- [GitHub](https://github.com/theskumar/python-dotenv) (👨‍💻 70 · 🔀 260 · 📦 130K · 📋 180 - 6% open · ⏱️ 14.07.2021):

	```
	git clone https://github.com/theskumar/python-dotenv
	```
- [PyPi](https://pypi.org/project/python-dotenv) (📥 9.9M / month):
	```
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 63 · 🔀 170 · 📦 1.4K · 📋 290 - 25% open · ⏱️ 20.07.2021):

	```
	git clone https://github.com/rochacbruno/dynaconf
	```
- [PyPi](https://pypi.org/project/dynaconf) (📥 350K / month):
	```
...
- [GitHub](https://github.com/sloria/environs) (👨‍💻 21 · 🔀 45 · 📦 4.5K · 📋 64 - 6% open · ⏱️ 12.05.2021):

	```
	git clone https://github.com/sloria/environs
	```
- [PyPi](https://pypi.org/project/environs) (📥 390K / month):
	```
...
- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 240 · 🔀 570 · 📦 21K · 📋 420 - 12% open · ⏱️ 15.07.2021):
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 120 · 🔀 360 · 📥 35K · 📦 530K · 📋 570 - 36% open · ⏱️ 16.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-dateutil) (📥 110M / month):
	```
...
- [GitHub](https://github.com/stub42/pytz) (👨‍💻 16 · 🔀 54 · 📦 800K · 📋 38 - 42% open · ⏱️ 22.03.2021):
...
- [GitHub](https://github.com/r1chardj0n3s/parse) (👨‍💻 30 · 🔀 82 · 📦 8.5K · 📋 80 - 20% open · ⏱️ 04.06.2021):
...
- [GitHub](https://github.com/cloudpipe/cloudpickle) (👨‍💻 46 · 🔀 110 · 📥 19 · 📦 39K · 📋 190 - 28% open · ⏱️ 01.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/cloudpickle) (📥 16M / month):
	```
...
- [GitHub](https://github.com/seperman/deepdiff) (👨‍💻 54 · 🔀 140 · 📦 2.2K · 📋 150 - 18% open · ⏱️ 30.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/deepdiff) (📥 3.2M / month):
	```
...
- [GitHub](https://github.com/GrahamDumpleton/wrapt) (👨‍💻 19 · 🔀 190 · 📋 130 - 39% open · ⏱️ 18.06.2021):
...
- [GitHub](https://github.com/uqfoundation/dill) (👨‍💻 30 · 🔀 120 · 📥 240K · 📋 340 - 37% open · ⏱️ 13.07.2021):
