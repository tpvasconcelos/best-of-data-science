...
- [GitHub](https://github.com/pallets/click) (👨‍💻 310 · 🔀 1.1K · 📦 630K · 📋 1.2K - 4% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/pygments/pygments) (👨‍💻 660 · 🔀 320 · 📦 260K · 📋 1.5K - 20% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 130 · 🔀 950 · 📦 7.9K · 📋 560 - 4% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/rich) (📥 2.4M / month):
	```
	pip install rich
	```
</details>
...
- [GitHub](https://github.com/tiangolo/typer) (👨‍💻 9 · 🔀 240 · 📋 210 - 54% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/typer) (📥 4M / month):
	```
	pip install typer
	```
</details>
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 100 · 🔀 230 · 📥 4.5K · 📦 15K · 📋 560 - 30% open · ⏱️ 01.10.2021):
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 30 · 🔀 450 · 📦 11K · 📋 470 - 15% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/loguru) (📥 1.9M / month):
	```
	pip install loguru
	```
</details>
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 76 · 🔀 140 · 📦 3.8K · 📋 190 - 15% open · ⏱️ 23.10.2021):
...
- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 21 · 🔀 44 · 📦 210 · 📋 56 - 8% open · ⏱️ 24.07.2021):

	```
	git clone https://github.com/bobbui/json-logging-python
	```
- [PyPi](https://pypi.org/project/json-logging) (📥 900K / month):
	```
...
- [GitHub](https://github.com/joblib/joblib) (👨‍💻 110 · 🔀 300 · 📦 140K · 📋 660 - 43% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 470 · 📋 93 - 49% open · ⏱️ 21.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/klepto) (📥 52K / month):
	```
	pip install klepto
	```
</details>
...
- [GitHub](https://github.com/theskumar/python-dotenv) (👨‍💻 71 · 🔀 280 · 📦 160K · 📋 190 - 7% open · ⏱️ 09.10.2021):
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 75 · 🔀 190 · 📦 1.8K · 📋 320 - 26% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/sloria/environs) (👨‍💻 22 · 🔀 49 · 📦 6K · 📋 68 - 8% open · ⏱️ 04.10.2021):

	```
	git clone https://github.com/sloria/environs
	```
- [PyPi](https://pypi.org/project/environs) (📥 500K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 81 · 🔀 370 · 📦 3 · 📋 900 - 9% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/hydra) (📥 5.1K / month):
	```
	pip install hydra
	```
</details>
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 380 · 📥 35K · 📦 580K · 📋 590 - 37% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-dateutil) (📥 220M / month):
	```
...
- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 250 · 🔀 590 · 📦 23K · 📋 440 - 13% open · ⏱️ 24.10.2021):

	```
	git clone https://github.com/arrow-py/arrow
	```
- [PyPi](https://pypi.org/project/arrow) (📥 5.3M / month):
	```
	pip install arrow
	```
</details>
...
- [GitHub](https://github.com/stub42/pytz) (👨‍💻 16 · 🔀 55 · 📦 890K · 📋 38 - 39% open · ⏱️ 11.10.2021):
...
- [GitHub](https://github.com/cloudpipe/cloudpickle) (👨‍💻 48 · 🔀 120 · 📥 19 · 📦 43K · 📋 200 - 30% open · ⏱️ 11.10.2021):

	```
	git clone https://github.com/cloudpipe/cloudpickle
	```
- [PyPi](https://pypi.org/project/cloudpickle) (📥 28M / month):
	```
...
- [GitHub](https://github.com/r1chardj0n3s/parse) (👨‍💻 30 · 🔀 83 · 📦 9.5K · 📋 81 - 20% open · ⏱️ 04.06.2021):
...
- [GitHub](https://github.com/seperman/deepdiff) (👨‍💻 57 · 🔀 140 · 📦 2.4K · 📋 160 - 17% open · ⏱️ 13.10.2021):
...
- [GitHub](https://github.com/GrahamDumpleton/wrapt) (👨‍💻 21 · 🔀 200 · 📋 140 - 19% open · ⏱️ 23.10.2021):

	```
	git clone https://github.com/GrahamDumpleton/wrapt
	```
- [PyPi](https://pypi.org/project/wrapt) (📥 37M / month):
	```
	pip install wrapt
	```
</details>
...
- [GitHub](https://github.com/uqfoundation/dill) (👨‍💻 31 · 🔀 130 · 📥 250K · 📋 360 - 38% open · ⏱️ 16.10.2021):
