...
- [GitHub](https://github.com/pallets/click) (👨‍💻 310 · 🔀 1.2K · 📦 650K · 📋 1.3K - 4% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/click) (📥 96M / month):
	```
	pip install click
	```
</details>
...
- [GitHub](https://github.com/pygments/pygments) (👨‍💻 660 · 🔀 320 · 📦 270K · 📋 1.5K - 20% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/pygments/pygments
	```
- [PyPi](https://pypi.org/project/Pygments) (📥 31M / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 190 · 🔀 570 · 📋 920 - 45% open · ⏱️ 03.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/prompt-toolkit) (📥 22M / month):
	```
...
- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 22 · 🔀 45 · 📦 210 · 📋 57 - 10% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 79 · 🔀 150 · 📋 200 - 13% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/hynek/structlog
	```
- [PyPi](https://pypi.org/project/structlog) (📥 2.6M / month):
	```
...
- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 500 · 📋 94 - 48% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/klepto) (📥 26K / month):
	```
	pip install klepto
	```
</details>
...
- [GitHub](https://github.com/theskumar/python-dotenv) (👨‍💻 71 · 🔀 280 · 📦 170K · 📋 190 - 7% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 75 · 🔀 190 · 📦 1.9K · 📋 320 - 26% open · ⏱️ 18.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/dynaconf) (📥 520K / month):
	```
...
- [GitHub](https://github.com/sloria/environs) (👨‍💻 23 · 🔀 50 · 📦 6.3K · 📋 68 - 5% open · ⏱️ 15.11.2021):
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 81 · 🔀 370 · 📦 3 · 📋 920 - 9% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 6.3K / month):
	```
	pip install hydra
	```
</details>
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 380 · 📥 35K · 📦 600K · 📋 590 - 37% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-dateutil) (📥 210M / month):
	```
...
- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 250 · 🔀 600 · 📦 23K · 📋 440 - 14% open · ⏱️ 05.11.2021):
...
- [GitHub](https://github.com/stub42/pytz) (👨‍💻 16 · 🔀 56 · 📦 910K · 📋 38 - 39% open · ⏱️ 11.10.2021):
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 68 · 🔀 250 · 📋 400 - 43% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 6.2M / month):
	```
...
- [GitHub](https://github.com/GrahamDumpleton/wrapt) (👨‍💻 21 · 🔀 200 · 📋 140 - 19% open · ⏱️ 29.10.2021):

	```
	git clone https://github.com/GrahamDumpleton/wrapt
	```
- [PyPi](https://pypi.org/project/wrapt) (📥 39M / month):
	```
	pip install wrapt
	```
</details>
