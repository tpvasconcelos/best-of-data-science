...
- [GitHub](https://github.com/pallets/click) (👨‍💻 310 · 🔀 1.1K · 📦 610K · 📋 1.2K - 4% open · ⏱️ 16.09.2021):

	```
	git clone https://github.com/pallets/click
	```
- [PyPi](https://pypi.org/project/click) (📥 92M / month):
	```
	pip install click
	```
</details>
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 120 · 🔀 880 · 📦 6.9K · 📋 530 - 2% open · ⏱️ 22.09.2021):
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.2K · 📦 9.1K · 📋 240 - 39% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 100 · 🔀 220 · 📥 4.5K · 📦 14K · 📋 550 - 29% open · ⏱️ 22.09.2021):

	```
	git clone https://github.com/getsentry/sentry-python
	```
- [PyPi](https://pypi.org/project/sentry-sdk) (📥 9.5M / month):
	```
...
- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 21 · 🔀 44 · 📦 200 · 📋 55 - 7% open · ⏱️ 24.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/json-logging) (📥 930K / month):
	```
...
- [GitHub](https://github.com/hynek/structlog) (👨‍💻 76 · 🔀 140 · 📦 3.6K · 📋 190 - 14% open · ⏱️ 21.09.2021):
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 72 · 🔀 300 · 📥 21 · 📦 1.7K · 📋 120 - 28% open · ⏱️ 19.05.2021):
...
- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 420 · 📋 91 - 52% open · ⏱️ 17.06.2021):

	```
	git clone https://github.com/uqfoundation/klepto
	```
- [PyPi](https://pypi.org/project/klepto) (📥 63K / month):
	```
	pip install klepto
	```
</details>
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 71 · 🔀 180 · 📦 1.6K · 📋 300 - 24% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/rochacbruno/dynaconf
	```
- [PyPi](https://pypi.org/project/dynaconf) (📥 420K / month):
	```
...
- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 24 · 🔀 140 · 📦 47K · 📋 67 - 13% open · ⏱️ 05.06.2021):

	```
	git clone https://github.com/henriquebastos/python-decouple
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 540K / month):
	```
	pip install python-decouple
	```
</details>
<details><summary><b><a href="https://github.com/sloria/environs">environs</a></b> (🥉26 ·  ⭐ 730 · 📉) - simplified environment variable parsing. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sloria/environs) (👨‍💻 21 · 🔀 47 · 📦 5.5K · 📋 68 - 10% open · ⏱️ 09.08.2021):

	```
	git clone https://github.com/sloria/environs
	```
- [PyPi](https://pypi.org/project/environs) (📥 460K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 80 · 🔀 350 · 📦 3 · 📋 880 - 8% open · ⏱️ 21.09.2021):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 6.4K / month):
	```
	pip install hydra
	```
</details>
...
- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 240 · 🔀 580 · 📦 22K · 📋 440 - 13% open · ⏱️ 21.09.2021):

	```
	git clone https://github.com/arrow-py/arrow
	```
- [PyPi](https://pypi.org/project/arrow) (📥 4.6M / month):
	```
	pip install arrow
	```
</details>
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 120 · 🔀 380 · 📥 35K · 📦 560K · 📋 590 - 37% open · ⏱️ 09.08.2021):
...
- [GitHub](https://github.com/stub42/pytz) (👨‍💻 16 · 🔀 54 · 📦 860K · 📋 38 - 39% open · ⏱️ 22.03.2021):
...
- [GitHub](https://github.com/cloudpipe/cloudpickle) (👨‍💻 48 · 🔀 110 · 📥 19 · 📦 41K · 📋 200 - 29% open · ⏱️ 23.09.2021):
