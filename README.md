...
- [GitHub](https://github.com/pallets/click) (👨‍💻 310 · 🔀 1.1K · 📦 620K · 📋 1.2K - 4% open · ⏱️ 10.10.2021):
...
- [GitHub](https://github.com/pygments/pygments) (👨‍💻 650 · 🔀 310 · 📦 260K · 📋 1.5K - 20% open · ⏱️ 12.10.2021):
...
<details><summary><b><a href="https://github.com/tiangolo/typer">typer</a></b> (🥉24 ·  ⭐ 6.4K · 📈) - Typer, build great CLIs. Easy to code. Based on Python type hints. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/typer) (👨‍💻 9 · 🔀 240 · 📋 210 - 55% open · ⏱️ 30.08.2021):

	```
	git clone https://github.com/tiangolo/typer
	```
- [PyPi](https://pypi.org/project/typer) (📥 2.9M / month):
	```
	pip install typer
	```
</details>
...
- [GitHub](https://github.com/bobbui/json-logging-python) (👨‍💻 21 · 🔀 44 · 📦 200 · 📋 55 - 7% open · ⏱️ 24.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/json-logging) (📥 1M / month):
	```
...
- [GitHub](https://github.com/Qix-/better-exceptions) (👨‍💻 15 · 🔀 180 · 📋 64 - 35% open · ⏱️ 24.08.2021):
...
- [GitHub](https://github.com/tkem/cachetools) (👨‍💻 7 · 🔀 120 · 📋 190 - 6% open · ⏱️ 11.10.2021):

	```
	git clone https://github.com/tkem/cachetools
	```
- [PyPi](https://pypi.org/project/cachetools) (📥 46M / month):
	```
...
- [GitHub](https://github.com/uqfoundation/klepto) (👨‍💻 2 · 🔀 23 · 📥 450 · 📋 92 - 53% open · ⏱️ 12.10.2021):

	```
	git clone https://github.com/uqfoundation/klepto
	```
- [PyPi](https://pypi.org/project/klepto) (📥 64K / month):
	```
	pip install klepto
	```
</details>
...
- [GitHub](https://github.com/theskumar/python-dotenv) (👨‍💻 71 · 🔀 270 · 📦 160K · 📋 190 - 8% open · ⏱️ 09.10.2021):
...
- [GitHub](https://github.com/rochacbruno/dynaconf) (👨‍💻 74 · 🔀 180 · 📦 1.7K · 📋 310 - 25% open · ⏱️ 14.10.2021):

	```
	git clone https://github.com/rochacbruno/dynaconf
	```
- [PyPi](https://pypi.org/project/dynaconf) (📥 490K / month):
	```
...
- [GitHub](https://github.com/sloria/environs) (👨‍💻 22 · 🔀 49 · 📦 5.8K · 📋 68 - 8% open · ⏱️ 04.10.2021):
...
- [GitHub](https://github.com/arrow-py/arrow) (👨‍💻 240 · 🔀 580 · 📦 22K · 📋 440 - 13% open · ⏱️ 05.10.2021):

	```
	git clone https://github.com/arrow-py/arrow
	```
- [PyPi](https://pypi.org/project/arrow) (📥 5.1M / month):
	```
	pip install arrow
	```
</details>
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 380 · 📥 35K · 📦 570K · 📋 590 - 37% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-dateutil) (📥 150M / month):
	```
...
- [GitHub](https://github.com/stub42/pytz) (👨‍💻 16 · 🔀 55 · 📦 880K · 📋 38 - 39% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytz) (📥 74M / month):
	```
	pip install pytz
	```
</details>
...
- [GitHub](https://github.com/cloudpipe/cloudpickle) (👨‍💻 48 · 🔀 110 · 📥 19 · 📦 42K · 📋 200 - 29% open · ⏱️ 11.10.2021):

	```
	git clone https://github.com/cloudpipe/cloudpickle
	```
- [PyPi](https://pypi.org/project/cloudpickle) (📥 27M / month):
	```
...
- [GitHub](https://github.com/r1chardj0n3s/parse) (👨‍💻 30 · 🔀 85 · 📦 9.3K · 📋 81 - 20% open · ⏱️ 04.06.2021):
...
- [GitHub](https://github.com/seperman/deepdiff) (👨‍💻 57 · 🔀 140 · 📦 2.4K · 📋 160 - 15% open · ⏱️ 13.10.2021):
...
- [GitHub](https://github.com/GrahamDumpleton/wrapt) (👨‍💻 21 · 🔀 200 · 📋 130 - 18% open · ⏱️ 13.10.2021):

	```
	git clone https://github.com/GrahamDumpleton/wrapt
	```
- [PyPi](https://pypi.org/project/wrapt) (📥 35M / month):
	```
	pip install wrapt
	```
</details>
...
- [GitHub](https://github.com/uqfoundation/dill) (👨‍💻 31 · 🔀 130 · 📥 240K · 📋 350 - 38% open · ⏱️ 12.10.2021):
